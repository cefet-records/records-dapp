...
export default function AddInstitution(): JSX.Element {
    ...
    useEffect(() => {
        if (isInstitutionAdded && generatedPublicKey && institutionAddress) {
            writeAddPublicKey({
                ...wagmiContractConfig,
                functionName: "addInstitutionPublicKey",
                args: [
                    institutionAddress as Address,
                    generatedPublicKey,
                ],
            });
    ...
    }, [isInstitutionAdded, generatedPublicKey, institutionAddress, writeAddPublicKey]);
            ...
            <form onSubmit={handleSubmit}>
                ...
                {downloadLink && overallSuccess && (
                    <div style={{ marginTop: '15px' }}>
                        ...
                        <a href={downloadLink} download={`${institutionAddress}_encrypted_private_key.json`}>
